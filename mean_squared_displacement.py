...
popt_linear, pcov_linear = scipy.optimize.curve_fit(linear, all_steps[fit_start:fit_end], data[fit_start:fit_end], p0=[8000.0, 0])
...
plt.axis([0, all_steps[num_runs], 0, b+all_steps[num_msd-1]*m])
